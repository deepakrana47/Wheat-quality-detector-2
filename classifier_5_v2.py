...
result_dir = '/media/zero/41FF48D81730BD9B/kisannetwork/codes_v2/weights_results_5out/'
...
if __name__ == "__main__":
    ...
    if os.path.isfile(feat_data):
        ...
        grain_partical_list = {k:get_files(v) for k,v in grain_particles.items()}
        ...
        print(' Number of damaged_grain: ', len(grain_partical_list['damaged_grain']))
        print(' Number of foreign: ', len(grain_partical_list['foreign']))
        print(' Number of grain: ', len(grain_partical_list['grain']))
        print(' Number of broken_grain: ', len(grain_partical_list['broken_grain']))
        print(' Number of grain_cover: ', len(grain_partical_list['grain_cover']))
